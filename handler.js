...
case 'fiturlist': {
 {
                ...
                kagura.sendListMsg(m.chat, `Saya Assisten ${ownername} ini adalah List Menu Bot Whatsapp Simple !!`, `© Created By ${ownername}`, `Hai ${pushname}👋 *Selamat ${salam}*`, `List Menu`, sections, m)
                }
            }
            break
